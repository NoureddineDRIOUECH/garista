...
function AddQrCode() {
    ...
    return (
        <>
        {
            ...
            :
            <>
            <div className={`grid sm:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-6 ${!expanded ? "md:grid-cols-2 lg:grid-cols-3 " :  "md:grid-cols-1 lg:grid-cols-2"}  gap-5`}>
                   {usersList.length > 0 && usersList.map((user, index) => (
                     ...
                     <Card onClick={handleDialogOpen} className="w-full cursor-pointer h-[280px] border-dashed grid place-content-center">
