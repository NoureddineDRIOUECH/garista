...
export default function DashboardCompany() {
  ...
  return (
    ...
    <>
        ...
        <div className="flex flex-col sm:gap-4 max-w-[90%] mx-auto">

            <main className="grid flex-1 items-start gap-10 p-4  sm:py-0 md:gap-8">
            <div className="mx-auto grid w-[90%] md:w-full md:max-w-[140rem] flex-1 auto-rows-max gap-4">

                <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-3 lg:gap-9">
                    <div className="grid auto-rows-max items-start gap-10 xl:col-span-2 lg:gap-8">
                        <Card >
                        <CardHeader>
