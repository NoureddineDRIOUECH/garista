...
function Tab({
  ...
  return (
    <div className="">
      ...
      <MenuItems infoRes={infoRes} dishes={dishes.length > 0 && dishes.filter(dish => selectedTab === 'All' || dish.categorie.name === selectedTab)} restoId={resto} selectedTab={selectedTab}/>
