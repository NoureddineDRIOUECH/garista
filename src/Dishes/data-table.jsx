...
export function DataTable({
  ...
  return (
    <>
      <div className="flex flex-col-reverse gap-5 md:flex-row md:items-center py-4  md:justify-between pr-4 border-b-[1px]">
                <div className="flex items-center gap-10 w-full md:w-5/12">
                    <Input
      ...
      <div className="rounded-md border">
        ...
        <div className="flex items-start md:items-center flex-col md:flex-row  justify-between px-2">
